...
import domain.PostVk;

public class PostManager {

    public PostVk[] search(int ownerId, String domain, String query, boolean ownersOnly. int count) {
        //int ownerId; //идентификатор пользователя или сообщества.
        //String domain; //короткий адрес пользователя или сообщества.
        //String query; //поисковой запрос
        //boolean ownersOnly; //возвращать только записи от имени владельца стены.
